    ...
    return (
        <div className="history-group">
            <div className="desc-font en text-year">
                <Fade left distance="50%" fraction={0.7}>
                    <p>2019</p>
                </Fade>
            </div>
            <div className="history-elements">
                <Fade left distance="50%" fraction={1}>
                    <p className="kr text-history">제 6회 컴퓨터공학과 학술제 입상(장려상)</p>
                </Fade>
                <Fade left distance="50%" fraction={1}>
                    <p className="kr text-history">캡스톤 2등했다.</p>
                </Fade>
                <Fade left distance="50%" fraction={1}>
                    <p className="kr text-history">Open Source S/W 대회 출전</p>
                </Fade>
            </div>
        </div>
    );
